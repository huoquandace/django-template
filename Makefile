...
manage:
	...
	@echo if __name__ == '__main__': main() >> $(MANAGE_FILE).py
	@echo # ------------------------------------------------------------------------- >> $(MANAGE_FILE).py
	@echo. >> $(MANAGE_FILE).py
